...
export interface GqlModuleOptions
  ...
  /**
   * Is federated service
   * See @apollo/federation for more details
   * this field is added as support for apollo graphql federation support
   * Author: Bala Krishna Ragala
   */
  isFederated?: boolean;
}
